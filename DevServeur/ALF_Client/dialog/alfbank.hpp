class ALF_BankMenu_Dialog {
	...
	class controlsBackground {
		class MainBackground: Life_RscPicture {
			text = "\ALF_Client\icons\creditmut_bg.paa";
			idc = -1;
	...
	class controls {
		...
		class piclivreta: Life_RscPicture {
			idc = 215051;
			text = "\ALF_Client\icons\creditmut_livreta.paa";
		...
		class piclivretaa: Life_RscPicture {
			idc = 215021;
			text = "\ALF_Client\icons\creditmut_acces_livreta.paa";
			x = 0.180312 * safezoneW + safezoneX;
			y = 0.335 * safezoneH + safezoneY;
			w = 0.304219 * safezoneW;
			h = 0.539 * safezoneH;
		...
		class piclivretb: Life_RscPicture {
			idc = 215061;
			text = "\ALF_Client\icons\creditmut_livretb.paa";
		...
		class piclivretbb: Life_RscPicture {
			idc = 215031;
			text = "\ALF_Client\icons\creditmut_acces_livretb.paa";
			x = 0.350469 * safezoneW + safezoneX;
			y = 0.335 * safezoneH + safezoneY;
			w = 0.304219 * safezoneW;
			h = 0.539 * safezoneH;
		...
		class piclivretc: Life_RscPicture {
			idc = 215071;
			text = "\ALF_Client\icons\creditmut_livretc.paa";
		...
		class piclivretcc: Life_RscPicture {
			idc = 215041;
			text = "\ALF_Client\icons\creditmut_acces_livretc.paa";
			x = 0.520625 * safezoneW + safezoneX;
			y = 0.335 * safezoneH + safezoneY;
			w = 0.304219 * safezoneW;
			h = 0.539 * safezoneH;
...
class ALF_BankAccess_Dialog {
	...
	class controlsBackground {
		class MainBackground: Life_RscPicture {
			text = "\ALF_Client\icons\creditmut_bg2.paa";
			idc = -1;
			x = 0.213854 * safezoneW + safezoneX;
			y = 0.141629 * safezoneH + safezoneY;
			w = 0.578542 * safezoneW;
	...
	class controls {
		...
		class picTransfertA: Life_RscPicture {
			idc = 225061;
			text = "\ALF_Client\icons\creditmut_transfert_bc.paa";
		...
		class picTransfertB: Life_RscPicture {
			idc = 225081;
			text = "\ALF_Client\icons\creditmut_transfert_ac.paa";
			x = 0.496354 * safezoneW + safezoneX;
			y = 0.404704 * safezoneH + safezoneY;
			w = 0.289324 * safezoneW;
			h = 0.520704 * safezoneH;
		...
		class picTransfertC: Life_RscPicture {
			idc = 225101;
			text = "\ALF_Client\icons\creditmut_transfert_ab.paa";
			x = 0.496354 * safezoneW + safezoneX;
			y = 0.404704 * safezoneH + safezoneY;
			w = 0.289324 * safezoneW;
			h = 0.520704 * safezoneH;
