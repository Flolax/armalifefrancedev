...
private["_plate","_fuel","_control","_index","_className","_dataArr","_vehicleColor","_vehicleInfo","_sellPrice","_retrievePrice","_insure"];
...
if(_insure isEqualTo 1) then { ctrlEnable [97480,false]; } else { ctrlEnable [97480,true]; };
