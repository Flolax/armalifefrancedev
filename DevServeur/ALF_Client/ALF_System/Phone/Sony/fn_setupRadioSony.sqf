...
private _freq = player getVariable "SonyFreq";
private _freq2 = player getVariable "SonyFreqAdd";
...
private _count51 = 0;
{
	private _freq = _x getVariable "SonyFreq";
	private _freq2 = _x getVariable "SonyFreqAdd";
	if(!isNil "_freq") then {
		switch (_freq) do {
			case 31 : {
				_count31 = _count31 + 1;
