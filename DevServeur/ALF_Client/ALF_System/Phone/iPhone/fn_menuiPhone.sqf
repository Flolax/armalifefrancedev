...
switch (_menu) do {
	case 0 : {
		...
		_menuNewMessage ctrlShow false;
		...
		if (life_callprogress) then {
			...
			_menu1rouge2 buttonSetAction "[] spawn ALF_fnc_resetCall;";
			if(iPhone_Mute) then {
			...
			if (life_phonering) then {
				...
				_menu1Name ctrlSetStructuredText parseText format["<t align='center' shadow='0' color='#FFFFFF' font='HelveticaNeueLTStdLt' size='1.5'>%1</t>", _hisName];
				_menu1Num ctrlSetStructuredText parseText format["<t align='center' shadow='0' color='#FFFFFF' font='HelveticaNeueLTStdLt' size='1.2'>%1</t>", _hisNumber];
				_menu1vert buttonSetAction "[] spawn ALF_fnc_answerCall;";
				_menu1rouge buttonSetAction "[] spawn ALF_fnc_resetCall;";
			} else {
				if(life_trycall) then {
					...
					if(life_forfait isEqualTo -1) then {
						_menu1sim ctrlShow false;
						_menu1btntel ctrlShow false;
						_menu1btnsms ctrlShow false;
						_menu1btncontacts ctrlShow false;
	...
	case 5 : {
		...
		private _text = "";
		if (life_is_anonyme) then {_menu5AnonymeON ctrlShow true; _menu5AnonymeOFF ctrlShow false;} else {_menu5AnonymeON ctrlShow false; _menu5AnonymeOFF ctrlShow true;};
		_menu5btnAnonyme buttonSetAction "[] spawn ALF_fnc_setiPhoneAnonyme;";
		switch (iPhone_Background) do {case 0 : {_text = "ALF";};case 1 : {_text = "Nuit 1";};case 2 : {_text = "Nuit 2";};case 3 : {_text = "Blup Blup";};case 4 : {_text = "Grahouuu";};};
		...
		switch (iPhone_Ring) do {case 0 : {_text = "Standard";};case 1 : {_text = "Minions";};case 2 : {_text = "Oklm";};};
		...
		if (MuteTone) then {_menu5viberON ctrlShow true; _menu5viberOFF ctrlShow false;} else {_menu5viberON ctrlShow false; _menu5viberOFF ctrlShow true;};
		_menu5btnviber buttonSetAction "[] spawn ALF_fnc_setiPhoneViber;";
		if (life_phoneoff) then {_menu5avionON ctrlShow true; _menu5avionOFF ctrlShow false;} else {_menu5avionON ctrlShow false; _menu5avionOFF ctrlShow true;};
		_menu5btnavion buttonSetAction "if(life_phoneoff)then{life_phoneoff=false;}else{life_phoneoff=true;}; [] call ALF_fnc_menuiPhone;";
	};
	...
	case 6 : {
		...
		[(player getvariable "myPhoneNumber") select 1,player] remoteExecCall ["HC_fnc_loadSmsiPhone",HC_Life];
		NewMessage = false;
	...
	case 8 : {
		...
		if (count life_phone_historique > 0) then {
			{
				...
				if (_type isEqualTo 0) then {
					_menu8recentlb lbSetPicture [(lbSize _menu8recentlb)-1,"\ALF_Client\icons\out.paa"];
				} else {
					_menu8recentlb lbSetPicture [(lbSize _menu8recentlb)-1,"\ALF_Client\icons\in.paa"];
				};
		...
		_menu6btnnew buttonSetAction "life_phone_historique = []; [] call ALF_fnc_menuiPhone;";
