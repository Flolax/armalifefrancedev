...
switch (_mode) do {
	...
	case 0 : {
		if (!life_lbactive) exitWith {["Crédit Mutuel", "Tu n'as pas de Livret B.", "danger", false] spawn ALF_fnc_doMsg;};
		...
		["Crédit Mutuel", format["Tu as tranféré %1€ du Livret A au Livret B.",_number], "success", false] spawn ALF_fnc_doMsg;
		[0] spawn ALF_fnc_updateCompteBancaire;
		[9] call SOCK_fnc_updatePartial;
	};

	case 1 : {
		if (!life_lcactive) exitWith {["Crédit Mutuel", "Tu n'as pas de Livret C.", "danger", false] spawn ALF_fnc_doMsg;};
		if (life_livreta < _number) exitWith {["Crédit Mutuel", "Tu n'as pas assez de fond sur ton Livret A.", "danger", false] spawn ALF_fnc_doMsg;};
		life_livreta = life_livreta - _number;
		life_livretc = life_livretc + _number;
		["Crédit Mutuel", format["Tu as tranféré %1€ du Livret A au Livret C.",_number], "success", false] spawn ALF_fnc_doMsg;
		[0] spawn ALF_fnc_updateCompteBancaire;
		[9] call SOCK_fnc_updatePartial;
	};
	...
	case 2 : {
		...
		life_livretb = life_livretb - _number;
		life_livreta = life_livreta + _number;
		["Crédit Mutuel", format["Tu as tranféré %1€ du Livret B au Livret A.",_number], "success", false] spawn ALF_fnc_doMsg;
	...
	case 3 : {
		...
		life_livretb = life_livretb - _number;
		life_livretc = life_livretc + _number;
		["Crédit Mutuel", format["Tu as tranféré %1€ du Livret B au Livret C.",_number], "success", false] spawn ALF_fnc_doMsg;
		[1] spawn ALF_fnc_updateCompteBancaire;
		[9] call SOCK_fnc_updatePartial;
	};
	...
	case 4 : {
		...
		life_livretc = life_livretc - _number;
		life_livreta = life_livreta + _number;
		["Crédit Mutuel", format["Tu as tranféré %1€ du Livret C au Livret A.",_number], "success", false] spawn ALF_fnc_doMsg;
	...
	case 5 : {
		...
		life_livretc = life_livretc - _number;
		life_livretb = life_livretb + _number;
		["Crédit Mutuel", format["Tu as tranféré %1€ du Livret C au Livret B.",_number], "success", false] spawn ALF_fnc_doMsg;
		[2] spawn ALF_fnc_updateCompteBancaire;
		[9] call SOCK_fnc_updatePartial;
	};
