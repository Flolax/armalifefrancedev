...
if(_length1 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
if(_length2 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
if(_length3 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
if(_length4 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
if(_length5 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
if(_length6 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
if(_length7 > 1) exitWith {hint "Tu ne peux écrire que 1 caractère."};
...
diag_log format["PLAQUE %1",_plaque];

[_plaque,player] remoteExec ["HC_fnc_recherchePlaque",HC_Life];
