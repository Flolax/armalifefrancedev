...
class Clothing {
    ...
    class cop {
        ...
        license = "";
        uniforms[] = {
            { "NONE", "Sans uniform", 0, { "", "", -1 } },
            { "u_gen_standard_mcam", "", 25, { "", "", -1 } },
            { "u_psig_1_mcam", "", 50, { "life_coplevel", "SCALAR", 1 } },
            { "u_psig_2_mcam", "", 50, { "life_coplevel", "SCALAR", 2 } },
            { "u_psig_3_mcam", "", 50, { "life_coplevel", "SCALAR", 1 } },
            { "u_gen_motard_mcam", "", 50, { "life_coplevel", "SCALAR", 1 } },
            { "u_grandfroid_mcam", "", 50, { "life_coplevel", "SCALAR", 1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_police", "", 25, { "", "", -1 } },
