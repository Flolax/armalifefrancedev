...
/*
	...
	Something
*/
private["_license","_itemInfo","_itemList","_license","_flag","_exit","_level","_levelAssert","_levelName","_levelType","_levelValue","_levelMsg"];
_exit = false;
...
if(!(EQUAL(_license,""))) then {
	_flag = M_CONFIG(getText,"Licenses",_license);
