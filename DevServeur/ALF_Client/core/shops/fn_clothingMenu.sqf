...
*/
private["_list","_clothes","_pic","_filter","_pos","_oldPos","_oldDir","_oldBev","_flag","_shopTitle","_license","_exit","_testLogic","_nearVeh","_ut1","_ut2","_ut3","_ut4","_ut5","_light"];
...
//Cop / Civ Pre Check
if((SEL(_this,3) in ["bruce","dive","reb","kart"])) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
if((SEL(_this,3) isEqualTo "reb" && !license_rebel)) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
if((SEL(_this,3) in ["cop"] && life_copLevel < 1)) exitWith {hint localize "STR_Shop_NotaCop"; closeDialog 0;};
if((SEL(_this,3) in ["dive"] && !license_dive)) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
